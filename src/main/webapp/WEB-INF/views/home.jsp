      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide" lazy="true">
          <div class="wrap-slider">
            <img class="lazyload" src="https://theme.hstatic.net/200000690725/1001078549/14/slide_3_img.jpg?v=536" alt="hp-slideshow-01">

          </div>
        </div>
        <div class="swiper-slide" lazy="true">
          <div class="wrap-slider row-end">
            <img class="lazyload" src="https://theme.hstatic.net/200000690725/1001078549/14/slide_4_img.jpg?v=536" alt="hp-slideshow-02">

          </div>
        </div>
        <div class="swiper-slide" lazy="true">
          <div class="wrap-slider">
            <img class="lazyload" src="https://theme.hstatic.net/200000690725/1001078549/14/slide_1_img.jpg?v=536" alt="hp-slideshow-03">
  ...
  <section class="flat-spacing-10 flat-testimonial">
    <div class="container" style="    height: max-content;">
      <div class="wrap-carousel style-2">
        <div class="swiper tf-sw-testimonial" data-preview="6" data-tablet="4" data-mobile="2" data-space-lg="30" data-space-md="15">
            ...
            <div class="swiper-slide">
              <div class="tf-icon-box text-center">
                ...
                <div class="content">
                  ...
                  <p>Miễn phí vận chuyển cho đơn hàng từ 300.000đ trở lên tại Việt Nam và 500.000đ tại Hà Nội.
                  </p>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="tf-icon-box text-center">
                ...
                <div class="content">
                  ...
                  <p>An tâm với chế độ bảo hành từ nhà sản xuất, đảm bảo sản phẩm của bạn luôn được bảo vệ.
                  </p>
                </div>
              </div>
            </div>
