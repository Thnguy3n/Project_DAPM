            ...
            <div class="grid-layout wrapper-shop" data-grid="grid-4">
                ...
                <div class="card-product">
                    <div class="card-product-wrapper">
                        <a href="<c:url value="/product-Detail"/>" class="product-img">
                    ...
                    <div class="card-product-info">
                        <a href="productDetail.jsp" class="title link">Ribbed Tank Top</a>
            ...
            <div class="widget-facet wd-categories">
                ...
                <div id="categories" class="collapse show">
                    <ul class="list-categoris current-scrollbar mb_36">
                        <li class="cate-item"><a href="#"><span>Accessories</span>&nbsp;<span>(14)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Baby</span></span>&nbsp;<span>(12)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Men</span>&nbsp;<span>(25)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Women</span>&nbsp;<span>(30)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Denim</span>&nbsp;<span>(22)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Dress</span>&nbsp;<span>(4)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Dog</span>&nbsp;<span>(7)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Eyeglasses</span>&nbsp;<span>(5)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Footwear</span>&nbsp;<span>(4)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Grocery</span>&nbsp;<span>(8)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Handbag</span>&nbsp;<span>(20)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Kids Clothing</span>&nbsp;<span>(12)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Outerwear</span>&nbsp;<span>(2)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Shoes</span>&nbsp;<span>(10)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Stroller</span>&nbsp;<span>(7)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Sunglasses</span>&nbsp;<span>(23)</span></a></li>
                        <li class="cate-item"><a href="#"><span>Tee</span>&nbsp;<span>(5)</span></a></li>
