                ...
                <div class="tf-control-sorting d-flex justify-content-end">
                    <div class="tf-dropdown-sort" data-bs-toggle="dropdown">
                        <div class="btn-select">
                            <span class="text-sort-value">Tìm kiếm</span>
                        ...
                        <div id="gallery" class="collapse show">
                            <div class="grid-3 gap-4 mb_36">
                                <a href="product-detail.html" class="item-gallery">
                                    <img class="lazyload" data-src="images/shop/gallery/gallery-1.jpg"
                                         alt="img-gallery">
                                </a>
                                <a href="product-detail.html" class="item-gallery">
                                    <img class="lazyload" data-src="images/shop/gallery/gallery-2.jpg"
                                         alt="img-gallery">
                                </a>
                                <a href="product-detail.html" class="item-gallery">
                                ...
                                <a href="product-detail.html" class="item-gallery">
                                    <img class="lazyload" data-src="images/shop/gallery/gallery-4.jpg"
                                         alt="img-gallery">
                                </a>
                                <a href="product-detail.html" class="item-gallery">
...
<div class="modal fade modalDemo" id="quick_view">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="wrap">
                <c:forEach items="${productView}" var="item">
                    ...
                    <div class="tf-product-info-wrap position-relative">
                        <div class="tf-product-info-list">
                            <div class="tf-product-info-title">
                                <h5><a class="link" href="<c:url value="product-Detail"/>">${item.title}</a></h5>
                            </div>
