                            ...
                            <div class="tf-product-info-list other-image-zoom">
                                ...
                                <div class="tf-product-info-badges">
                                    ...
                                    <div class="product-status-content">
                                        ...
                                        <p class="fw-6">Bán nhanh! Đã có 56 người mua sản phẩm này trong giỏ hàng</p>
                                    </div>
                                </div>
                                ...
                                <div class="tf-product-info-countdown">
                                    <div class="countdown-wrap">
                                        ...
                                        <div class="tf-countdown style-1">
                                            <div class="js-countdown" data-timer="1007500" data-labels="Ngày :,Giờ :,Phút :,Giây"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-product-info-variant-picker">
                                    <div class="variant-picker-item">
                                        <div class="variant-picker-label">
                                            Màu: <span class="fw-6 variant-picker-label-value">Be</span>
                                        </div>
                                        <div class="variant-picker-values">
                                            <input id="values-beige" type="radio" name="color1" checked>
                                            <label class="hover-tooltip radius-60" for="values-beige" data-value="Be">
                                                <span class="btn-checkbox bg-color-beige"></span>
                                                <span class="tooltip">Be</span>
                                            </label>
                                            <input id="values-black" type="radio" name="color1">
                                            <label class=" hover-tooltip radius-60" for="values-black" data-value="Đen">
                                                <span class="btn-checkbox bg-color-black"></span>
                                                <span class="tooltip">Đen</span>
                                            </label>
                                            <input id="values-blue" type="radio" name="color1">
                                            <label class="hover-tooltip radius-60" for="values-blue" data-value="Xanh lam">
                                                <span class="btn-checkbox bg-color-blue"></span>
                                                <span class="tooltip">Xanh lam</span>
                                            </label>
                                            <input id="values-white" type="radio" name="color1">
                                            <label class="hover-tooltip radius-60" for="values-white" data-value="Trắng">
                                    ...
                                    <div class="variant-picker-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#find_size" data-bs-toggle="modal" class="find-size fw-6">Tìm kích thước của bạn</a>
                                        </div>
                                        <div class="variant-picker-values">
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        <a href="#" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn "><span>Thêm vào giỏ hàng -&nbsp;</span><span class="tf-qty-price">$8.00</span></a>
                                        ...
                                        <div class="w-100">
                                            <a href="#" class="btns-full">Mua bằng <img src="images/payments/paypal.png" alt=""></a>
                                            <a href="#" class="payment-more-option">Nhiều lựa chọn thanh toán hơn</a>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-12">
                                            <div class="tf-product-delivery">
                                                ...
                                                <p>Thời gian giao hàng ước tính: <span class="fw-7">12-26 ngày</span> (Quốc tế), <span class="fw-7">3-6 ngày</span> (Việt Nam).</p>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-12">
                                            <div class="tf-product-delivery mb-0">
                                                ...
                                                <p>Trả hàng trong vòng <span class="fw-7">30 ngày</span> kể từ ngày mua. Thuế và phí không được hoàn lại.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="widget-tabs style-has-border">
                        ...
                        <div class="widget-content-tab">
                            <div class="widget-content-inner active">
                                <div class="">
                                    <p class="mb_30">
                                        Áo sơ mi tay cài nút và kiểu dáng thoải mái. Được may đo bằng vải có kết cấu nhăn, mềm mại được làm từ sợi Lencoze LENZING™ ECOVERO™ — sợi gỗ có nguồn gốc
                                        có trách nhiệm
                            ...
                            <div class="widget-content-inner">
                                <div class="tf-page-privacy-policy">
                                    ...
                                    <p>Chúng tôi không chịu trách nhiệm về nội dung hoặc các thông lệ về quyền riêng tư trên bất kỳ trang web nào.</p>
                                    <p>Chúng tôi có toàn quyền quyết định sửa đổi, cập nhật, bổ sung, ngừng, xóa hoặc thay đổi bất kỳ phần nào của Chính sách quyền riêng tư này, toàn bộ hoặc một phần, bất kỳ lúc nào. Khi chúng tôi sửa đổi Chính sách bảo mật này, chúng tôi sẽ sửa đổi ngày "cập nhật lần cuối" nằm ở đầu Chính sách bảo mật này.</p>
                                    ...
                                    <p>Nếu bạn có bất kỳ câu hỏi nào liên quan đến Chính sách bảo mật này, bạn nên liên hệ với Bộ phận dịch vụ khách hàng của chúng tôi qua email tại marketing@company.com</p>
                                </div>
                            </div>
                            <div class="widget-content-inner">
                                ...
                                <p class="text-center text-paragraph">LT01: 70% len, 15% polyester, 10% polyamide, 5% acrylic 900 Gram/tấn</p>
                            </div>
                        </div>
                    </div>
                </div>
